    ...
    public class PatientRecord
    {
        ...
        public void DisplayPatientTreatments(int patientId)
        {
            ...
            if (patient is InternalPatient)
            {
                ...
                while (currentInternal != null)
                {
                    Console.WriteLine("Internal Treatment ID: " + currentInternal.Data.TreatmentID);
                    ...
                    Console.WriteLine("Discharge Date: " + currentInternal.Data.DischargeDate.ToString("dd/MM/yyyy"));
                    Console.WriteLine("-----------------------------------");
                ...
                while (currentExternal != null)
                {
                    Console.WriteLine("External Treatment ID: " + currentExternal.Data.TreatmentID);
            ...
            else if (patient is ExternalPatient)
            {
                ...
                while (current != null)
                {
                    Console.WriteLine("External Treatment ID: " + current.Data.TreatmentID);
